...
- CI now pins third-party action SHAs and emits an unsigned commit/artifact provenance manifest; signed OIDC attestation remains a release-owner gate. The latest local provenance evidence covers 36 artifacts at commit `d95361644c4911e0c9eca949ba26c689a1312f8a`; signed OIDC attestation remains an external release-owner gate.
