...
- CI now pins third-party action SHAs and emits an unsigned commit/artifact provenance manifest; signed OIDC attestation remains a release-owner gate. The latest local provenance evidence covers 36 artifacts at commit `b35fb2128edaedc8985a2a8306d3df6b0e3ed484`; signed OIDC attestation remains an external release-owner gate.
