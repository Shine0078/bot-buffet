...
- CI now pins third-party action SHAs and emits an unsigned commit/artifact provenance manifest; signed OIDC attestation remains a release-owner gate. The latest local provenance evidence covers 36 artifacts at commit `e5e50113038837e4d48c1be36778d448fd8a916f`; signed OIDC attestation remains an external release-owner gate.
