...
- CI now pins third-party action SHAs and emits an unsigned commit/artifact provenance manifest; signed OIDC attestation remains a release-owner gate. The latest local provenance evidence covers 36 artifacts at commit `ece681c72d15e622af28529149102e080651a9fb`; signed OIDC attestation remains an external release-owner gate.
