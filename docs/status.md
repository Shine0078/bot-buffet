...
- CI now pins third-party action SHAs and emits an unsigned commit/artifact provenance manifest; the latest local provenance evidence covers 43 build artifacts; signed OIDC attestation remains a release-owner gate.
