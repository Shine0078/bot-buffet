...
| Plugins                        | Complete locally, live connectors unproven | Lifecycle with integrity pinning, scoped activation, allowedPluginIds/projectIds/network enforced on plugin.invoke, fail-closed mcp.invoke, and the eight-connector catalog that grants no authority on install                      |
