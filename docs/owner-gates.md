...
- Security owner: validate the pinned provider socket transport with DNS-rebinding tests and provide a kernel/container sandbox escape report; the local child-process boundary is not sufficient evidence.
